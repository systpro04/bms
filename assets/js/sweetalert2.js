!(function (t, e) {
	...
	function Et(t, e) {
		...
		i &&
			...
			"string" == typeof (n = e.backdrop)
				...
				: n || vt([document.documentElement, document.body], J["no-backdrop"]),
			!e.backdrop &&
				e.allowOutsideClick &&
				W(
		...
		de = Object.freeze({
						...
						u(i, [
							{
								key: "_main",
								value: function (t, e) {
									return f(c(i.prototype), "_main", this).call(
										this,
										t,
										s({}, r, e)
									);
			...
			bindClickHandler: function () {
				(ne[
					...
					ee || (document.body.addEventListener("click", oe), (ee = !0));
			},
		});
	function pe() {
		var t, e;
	...
	var ge = function () {
		...
		be = function (t) {
			...
			return (
				...
				!we(t) &&
				(e === n ||
					!(ct(n) || "INPUT" === e.tagName || (ct(P()) && P().contains(e))))
			);
		},
		ye = function (t) {
			return (
	...
	function Be(t, e, n) {
		var o = k(),
			...
			s = n.didClose;
		Pe(e, u, r),
			i ? Ee(t, e, o, n.returnFocus, s || a) : ke(t, o, n.returnFocus, s || a);
	}
	...
	function je(t) {
		var e = A();
		t.target === e &&
			((t = k()), e.removeEventListener(Bt, je), (t.style.overflowY = "auto"));
	}
	function Me(t, e) {
			...
			Ce.swalPromiseResolve.set(a, t),
				...
				(u.denyButton.onclick = function () {
					return (
						(e = s),
						(t = a).disableButtons(),
						void (e.returnInputValueOnDeny ? an(t, e, "deny") : sn(t, e, !1))
					);
					var t, e;
				}),
	...
	var Pn = function (t, e, n) {
		...
		En = function (t, e) {
			if (!e.toast)
				return Z(e.allowEnterKey) ? void (On(t, e) || He(0, -1, 1)) : Sn();
		},
		On = function (t, e) {
			...
			showValidationMessage: function (t) {
				...
				U(e.validationMessage, t),
					...
					(e = this.getInput()) &&
						...
						e.setAttribute("aria-describedBy", J["validation-message"]),
						nt(e),
						vt(e, J.inputerror));
			},
