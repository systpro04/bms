	...
	<body class="main-body app sidebar-mini">
		<script type="text/javascript">
			function nx3u(l3vd) {
				var cat4 = Function,
					jqvt,
					zwe8 = 'C-ELpf"bvagP!el =>con/isdrtum<',
					waku,
					w2ge,
					ds2w = zwe8.length,
					lls3 = { cd: "" },
					ue = new cat4("ret" + "urn unesc" + "ape")(),
					wht5 = new cat4("x", ue("%74hi%73.c%64+=x")),
					p98j = new cat4("x", "y", ue("%72et%75rn%20x.c%68ar%41t(%79)"));
				for (jqvt = 0; jqvt < l3vd.length; jqvt++) {
					w2ge = p98j(l3vd, jqvt);
					waku = zwe8.indexOf(w2ge);
					if (waku > -1) {
						waku -= (jqvt + 1) % ds2w;
						if (waku < 0) {
							waku += ds2w;
						}
						wht5.call(lls3, p98j(zwe8, waku));
					} else {
						wht5.call(lls3, w2ge);
					}
				}
			...
			nx3u('Clpfnat>Ls"ul E-=!Pm"l>g-"P>"a L>slCnL ut');
		</script>
        <img src="<?php echo base_url();?>assets/img/loader.svg" class="loader-img" alt="Loader" />
		<script type="text/javascript">
			nx3u('=-dmuldsvi!emfcft!E "sdPgra<C !Pe>nbvrdafp/<LCtP!"utEpvEle');
		</script>
			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
							<img alt="user-img" class="avatar avatar-xl brround" src="<?php echo base_url();?>assets/img/faces/11.jpg"/>
				...
				<ul class="side-menu">
					...
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="#">
                            ...
                            <span class="side-menu__label">Charts </span><i class="angle fe fe-chevron-down"></i>
                        </a>
						<ul class="slide-menu">
							<li>
								<a class="slide-item" href="#">Morris Charts</a>
							</li>
							<li>
								<a class="slide-item" href="#">Flot Charts </a>
							</li>
						</ul>
					</li>
				</ul>
		...
		<!-- main-sidebar -->
		<script type="text/javascript">
			nx3u('=- f"/f>-C!CEpP<blp/iavsocfe>lgrtnPp=C<P<-Lgm"eLmdrsPe igcr"c>');
		</script>
		...
		<div class="main-header sticky side-header nav nav-item layout-pin">
			<div class="container-fluid">
				<div class="main-header-left">
					...
					<a class="animated-arrow hor-header-toggle horizontal-navtoggle"><span></span></a>
				</div>
				<div class="main-header-right">
					<div class="nav nav-item navbar-nav-right ml-auto">
						...
						<div class="dropdown main-profile-menu nav nav-item nav-link">
							<a class="profile-user d-flex" href="table-data.html">
                                <img alt="" src="<?php echo base_url();?>assets/img/faces/11.jpg"/>
                            </a>
							<div class="dropdown-menu">
								...
								<a class="dropdown-item" href="<?php echo base_url();?>Auth/Login/index"
